...
const solicitorNav = [
  {
    group: "Dashboard",
    items: [
      { to: "/solicitor", label: "Overview", icon: LayoutGrid },
    ],
  },
  {
    group: "Case Operations",
    items: [
      { to: "/solicitor/matters", label: "Matter Management", icon: FileStack },
      { to: "/solicitor/documents", label: "Documents & OCR", icon: FileText },
      { to: "/solicitor/tasks", label: "Tasks & Requests", icon: ListTodo },
    ],
  },
  {
    group: "Compliance & Audit",
    items: [
      { to: "/solicitor/audit", label: "Audit Timeline", icon: History },
      { to: "/solicitor/notifications", label: "Notifications", icon: Bell },
    ],
  },
];
    ...
    <div className="flex h-full flex-col gap-6 overflow-y-auto px-4 py-6">
      ...
      <div className="px-2 py-1.5 rounded-xl bg-sidebar-accent/50 border border-sidebar-border/60">
        ...
        <p className="mt-1 text-[0.68rem] text-sidebar-foreground/70">
          Solicitor Portal • SRA ID: 629104
        </p>
      </div>
      ...
      <div className="rounded-xl border border-sidebar-border/70 bg-sidebar-accent/30 p-3.5 space-y-2">
        <div className="flex items-center justify-between">
          ...
          <span className="inline-flex items-center gap-1 text-[0.65rem] font-semibold text-emerald-400">
            <span className="size-1.5 rounded-full bg-emerald-400 animate-pulse" /> Active v4.2
          </span>
        </div>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56">
                  ...
                  <DropdownMenuItem onClick={() => handleRoleSwitch("admin")}>
                    <ShieldCheck className="size-4 mr-2" /> Admin Control Centre
                  </DropdownMenuItem>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56">
                  <DropdownMenuLabel>
                    ...
                    <span className="block text-xs text-muted-foreground">r.okonkwo@fgdebtadvisor.co.uk</span>
